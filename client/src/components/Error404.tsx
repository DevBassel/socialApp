...
export default function Error404() {
  return (
    <div className="wrapper flex relative items-center justify-center w-full md:w-[80%] h-[calc(100vh_-_125px)] mx-auto ">
      <Link
        className="absolute bottom-0 text-3xl hover:scale-110 transition-all duration-500 font-sans block mx-auto w-fit bg-white text-black font-extrabold rounded-md p-1"
        to={"/"}
      >
        To Home
      </Link>
